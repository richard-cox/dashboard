...
// import { ProxiedResource, ProxyResourceInstance } from './resource-proxy';
// // import Vue from 'vue';
...
// type WrapPropertiesInFunction<T extends { [key: string]: any; }> = {
//   [P in keyof T]: (proxy: ProxiedResource) => T[P] // TODO: RC proxy to default to kube type
// };

// const ResourceInstance: WrapPropertiesInFunction<ProxyResourceInstance> = {
...
// ResourceInstance.customValidationRules;
