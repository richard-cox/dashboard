...
import {
  ...
  CURRENT, READY, DESIRED, SCHEDULE, LAST_SCHEDULE, UP_TO_DATE, AVAILABLE, DURATION, COMPLETIONS, RESTARTS, IP
...
export function init(store) {
  ...
  headers(WORKLOAD_TYPES.DEPLOYMENT, [STATE, NAME_COL, NAMESPACE_COL, WORKLOAD_IMAGES, WORKLOAD_ENDPOINTS, READY, UP_TO_DATE, AVAILABLE, POD_RESTARTS, AGE, WORKLOAD_HEALTH_SCALE]);
  ...
  headers(WORKLOAD_TYPES.CRON_JOB, [STATE, NAME_COL, NAMESPACE_COL, WORKLOAD_IMAGES, WORKLOAD_ENDPOINTS, SCHEDULE, LAST_SCHEDULE, POD_RESTARTS, AGE, WORKLOAD_HEALTH_SCALE]);
