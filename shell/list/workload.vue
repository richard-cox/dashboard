...
export default {
  ...
  data() {
    ...
    const includeAssociatedData = paginationEnabled && [
      WORKLOAD_TYPES.DEPLOYMENT,
      WORKLOAD_TYPES.DAEMON_SET, // TODO: RC test
      WORKLOAD_TYPES.REPLICA_SET, // TODO: RC test
      WORKLOAD_TYPES.STATEFUL_SET, // TODO: RC test
      WORKLOAD_TYPES.JOB, // TODO: RC test
      WORKLOAD_TYPES.REPLICATION_CONTROLLER // TODO: RC test
    ].includes(type);
